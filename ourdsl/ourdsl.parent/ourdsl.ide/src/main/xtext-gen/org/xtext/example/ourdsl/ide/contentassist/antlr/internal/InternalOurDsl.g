...
{ before(grammarAccess.getGreetingAccess().getDslOneMyGreetingIDTerminalRuleCall_3_0_1()); }
	RULE_ID{ after(grammarAccess.getGreetingAccess().getDslOneMyGreetingIDTerminalRuleCall_3_0_1()); }
)
...
{ before(grammarAccess.getGreetingAccess().getDslTwoYourGreetingIDTerminalRuleCall_5_0_1()); }
	RULE_ID{ after(grammarAccess.getGreetingAccess().getDslTwoYourGreetingIDTerminalRuleCall_5_0_1()); }
)
